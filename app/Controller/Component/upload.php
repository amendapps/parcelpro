<?php
	...
	class UploadComponent extends Object {
		...
		/**
		  ...
		  *			- rules['type'] = string ('original','resize','resizemin','resizecrop','crop')
		...
		function upload ($file, $destination, $name = NULL, $rules = NULL, $allowed = NULL) 
		{
			...
			if (isset($file) && is_array($file) && !$this->upload_error($file['error'])) {
				...
				$fileName = ($name == NULL) ? $this->uniquename($destination . $file['name']) : $destination . $name.".".$this->ext($file['name']);
		...
		function image ($file, $type, $size, $output = NULL, $quality = NULL) {
			...
			$this->_name=($this->_name == NULL) ? WWW_ROOT.'img/couponimage/'. $file['name'] : $this->_name;
