...
<div>
				...
				<?php echo $this->Form->create('Page', array('name'=>'page','action' => 'delete','onSubmit'=>'return validate(this)','class'=>'table-form'));?>
				<?php echo $this->Form->hidden('action',array('id'=>'action','value'=>'')); ?>
                                ...
                                <table >
										...
										<tr>
											<td><?php echo $this->Form->checkbox($press['Page']['id'],array('value'=>$press['Page']['id'])); ?></td>
											<td>
												<script type="text/javascript">
														j(document).ready(function() {
															j("#various<?php echo $press['Page']['id'];?>").fancybox({
														});
													});
												</script>
																							</td>
											<td><?php echo $i; ?></td>
											<td><?php echo $press['Page']['page_name']; ?></td>
											<td>
												
												<ul class="actions">
													<li><?php echo $this->Html->link('edit', array('controller'=>'pages', 'action' => 'admin_edit',$press['Page']['id']), array('escape' => false,'class'=>'edit','title'=>'Edit Project','rel'=>'tooltip'));?></li>
													<li><a href="#view<?php echo $press['Page']['id'];?>" id="various<?php echo $press['Page']['id'];?>"  class="view" title="View Page" rel="tooltip">view</a></li>
																												
												</ul>
                                                 
                                        <div style="display: none;">
                                        <div id='view<?php echo $press['Page']['id'];?>' style="background:#f6f6f6; padding:8PX; max-height:550px; overflow-y:auto;">
                                            	<div style="padding:10px 0;">
							 <div style="float:left; width:110px;"><b>Page Title</b></div>
                                                      <div align="justify;" style="float:left; width:400px;"><?php echo $press['Page']['page_name'];?></div>
