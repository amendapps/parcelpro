...
<?php if($detail){?>
	 ...
	 <table style="margin-left: 180px;">
		...
		<tr>
			...
			<td><?php echo $d['Address']['name']?></td><td><?php echo $this->Html->link('Change sender detail',array('controller'=>'quotations','action'=>'sender_contact_detail_edit',$d['Address']['id']));?></td>
			 <td>&nbsp;</td>
...
<table border="0" width="995px" cellpadding="0" cellspacing="4" style="margin-left: 180px; text-align: left">
	...
	<tr>
		  <td colspan='2'><?php echo $this->Html->link('Back to Compare Price',array('Controller'=>'quotations','action'=>'quotation_compare_price')); ?></td>
	</tr>
