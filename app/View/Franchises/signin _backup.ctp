<section id="banner-wrap">
  ...
  <div class="quote-form"> <span class="titel">Franchises Signin</span>
     ...
     <table cellspacing="4px;">
     	 <tr><td colspan="2" style="color:red;"><?php echo $this->Session->flash(); ?></td></tr>
         <tr><td>Username</td><td><?php echo $this->Form->text('username',array('style'=>'width:250px; height:25px;')); ?></td><tr>
         <tr><td>&nbsp;</td></tr>
