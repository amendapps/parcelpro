<div id="main_wapper">
    ...
    <div class="signup-form-wrap">
       ...
       <?php echo $this->Form->create('Franchise',array('name'=>'franchise','url'=>array('controller'=>'franchises','action'=>'franchises_register'),'onsubmit'=>'return frenchiseRegister();'))?>
	...
	<!-- <label>User Type :</label>-->
         <?php echo $this->Form->hidden('user_type',array('value'=>'F')); ?>
