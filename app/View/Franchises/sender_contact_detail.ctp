...
<?php if($detail){?>
	 ...
	 <table style="margin-left: 180px;">
		...
		<tr>
			...
			<td><?php echo $d['Address']['name']?></td><td><?php echo $this->Html->link('Change sender detail',array('controller'=>'franchises','action'=>'sender_contact_detail_edit',$d['Address']['id']));?></td>
			 <td>&nbsp;</td>
			 <td><?php echo $this->Html->link('Continue',array('controller'=>'franchises','action'=>'recipient_contact_detail'))?></td>  
		</tr>
		<tr>
...
f	 <?php echo $this->Form->create('Address',array('url'=>array('controller'=>'franchises','action'=>'sender_contact_detail')))?>
	 <tr>
	 ...
	 <tr>	<td>&nbsp;</td></tr>
	 <tr>	<td colspan='2'><b><h2><b>Your (the sender) contact details:</b></h2></b></td></tr>
	 	 <tr><td>&nbsp;</td></tr>
		  ...
		  <tr>
		   ...
		   <tr>
			...
			<td>Telephone :</td><td><?php echo $this->Form->text('telephone',array('style'=>'width:250px; height:25px;'));?></td>
		        ...
		        <tr>
			 <td>Notes :</td><td><?php echo $this->Form->text('notes',array('style'=>'width:250px; height:25px;'));?></td>
		 </tr>
                         <tr>
