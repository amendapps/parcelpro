 ...
 function picker($fieldName, $options = array()) {
      ...
      // That's new !
       ...
       // $options['div']['class'] = 'date';
        $options['after'] = $this->Html->link($this->Html->image('../js/jscalendar/img.gif',array('border'=>'0','hspace'=>'5','vspace'=>'0')), '#', array('onClick'=>"return showCalendar('".$htmlAttributes['id']."', '".$this->format."'); return false;"), null, false);
