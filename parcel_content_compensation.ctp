...
<?php if($compansion){?>		
	 <table style="margin-left: 180px;">		
		<tr>
			...
			<td>
			<?php echo $this->Html->link('Change Parcel Detail',array('controller'=>'quotations','action'=>'parcel_content_compensation_edit',$comp['Parcel']['id']));?></td><td>						             <?php echo $this->Html->link('Continue',array('controller'=>'quotations','action'=>'quotation_detail_review'));?></td>			
		</tr>
		<tr>
			<th>Quantity</th>
			<th>Description</th>
...
var text_div = '<div class="parcel-row">'+
				'<div class="detail-columns"><input type="text" id="quantity'+i+'" name="data[quantity]['+i+']"></div>'+
				'<div class="detail-columns"><input type="text" id="item_description'+i+'" name="data[item_description]['+i+']"></div>'+
				...
				'<div class="detail-columns"><input type="text" id="weight'+i+'" name="data[weight]['+i+']"></div>'+
				'<div class="detail-columns"><input type="text" id="total_value'+i+'" name="data[total_value]['+i+']"><a id=row'+i+'><img  src="../img/ico-delete.gif"/></a></div>'+
			    '</div>';
